...
Requires: perl-Net-Ident-license
Requires: perl-Net-Ident-man
...
%package man
Summary: man components for the perl-Net-Ident package.
Group: Default

%description man
man components for the perl-Net-Ident package.
...
mkdir -p %{_topdir}/BUILD/Net-Ident-1.24/deblicense/
...
%install
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/doc/perl-Net-Ident
cp deblicense/copyright %{buildroot}/usr/share/doc/perl-Net-Ident/deblicense_copyright
if test -f Makefile.PL; then
...
%files
%defattr(-,root,root,-)
/usr/lib/perl5/site_perl/5.26.1/Net/Ident.pm

%files license
%defattr(-,root,root,-)
/usr/share/doc/perl-Net-Ident/deblicense_copyright
